...
elseif ($useMember == "0") {
 ...
 ?>
  ...
  $q ="INSERT INTO `laundryservice` (`serviceId`,`memberId`,`dateIn`,`dateOut`,`serviceStatus`,`totalPrice`, `roomNo`) VALUES('$servideId','$memberIdToRegis','$currentDate','-','P','$totalPrice', '$roomNo')";
  $result=$mysqli->query($q);
  if(!$result){
    echo "INSERT failed. Error: ".$mysqli->error ;
  }
